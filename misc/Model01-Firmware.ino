...
KEYMAPS(
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   LCTRL(Key_LeftShift), Key_Z, Key_X, Key_C, Key_V, Key_B, Key_LeftGui,
   Key_LeftControl, Key_Spacebar, Key_LeftShift, Key_LeftAlt,
   ShiftToLayer(FUNCTION),


   Key_Backspace,  Key_6, Key_7, Key_8,     Key_9,         Key_0,         Key_PrintScreen,
  ...
  (LGUI(Key_Spacebar),      Key_F1,     Key_F2,      Key_F3,     Key_F4,        Key_F5,       LCTRL(LGUI(Key_Spacebar)),
